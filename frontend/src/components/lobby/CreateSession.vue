      ...
      >
        ...
        >
          <button
            ...
            class="bg-black/80 border-8 border-double border-amber-600 text-amber-600 font-mono text-xl font-bold py-4 px-8 rounded-lg tracking-[0.2em] shadow-[0_0_15px_rgba(255,191,0,0.3)] transition-all duration-200 select-none"
          >
